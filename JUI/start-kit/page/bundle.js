...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeLineLightBox = __webpack_require__(160);
	...
	var lightBoxData=[
			...
			console.log(slider);
			ReactDOM.render(
			  React.createElement(TimeLineLightBox, {list: lightBoxData}),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var TimeLineLightBoxBar = __webpack_require__(161);
	var TimeLineLightBoxImg = __webpack_require__(162);
	var TimeLineLightBoxList = __webpack_require__(163);
	var TimeLineLightBoxBtn = __webpack_require__(164);

	//TimeLineBox
	var TimeLineLightBox=React.createClass({displayName: "TimeLineLightBox",
		getInitialState:function(){
			return {num:1}
		},		
		...
		render:function(){
			...
			return (
				...
				React.createElement("span", {style: style.bar}, "1111"), 
				React.createElement(TimeLineLightBoxBar, {list: this.props.list, num: this.state.num}), 
				React.createElement(TimeLineLightBoxImg, {list: this.props.list, num: this.state.num}), 
				React.createElement(TimeLineLightBoxList, {list: this.props.list, num: this.state.num, callbackParent: this.onChildChanged}), 
				React.createElement(TimeLineLightBoxBtn, {list: this.props.list, num: this.state.num, callbackParent: this.onChildChanged})
				)
			);	
		}
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeLineLightBoxBar=React.createClass({displayName: "TimeLineLightBoxBar",
		render:function(){
			var index=this.props.num-1;
			return(
				React.createElement("span", null, this.props.num, this.props.list[index].title)
			);
		}
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeLineLightBoxImg=React.createClass({displayName: "TimeLineLightBoxImg",
		render:function(){
			var index=this.props.num-1;
			return(
				React.createElement("div", null, 
					React.createElement("img", {src: this.props.list[index].large})
				)
			);
		}
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeLineLightBoxList=React.createClass({displayName: "TimeLineLightBoxList",
		...
		render:function(){
			...
			return(
				React.createElement("ul", {className: "slide"}, 
					this.props.list.map(function(data,index) {
						return (React.createElement("li", {onClick: this.handleClick.bind(this,index), key: index}, React.createElement("a", {href: "javascript:void(0)"}, React.createElement("img", {src: data.thumb}))))
					},this)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeLineLightBoxBtn=React.createClass({displayName: "TimeLineLightBoxBtn",
		getInitialState:function(){
		...
		render:function(){
			return(
				React.createElement("div", null, 
				React.createElement("a", {href: "javascript:void(0)", onClick: this.handlePrevClick}, "上一张"), 
				React.createElement("a", {href: "javascript:void(0)", onClick: this.handleNextClick}, "下一张")
				)
			);
		}
	})
